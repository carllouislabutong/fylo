    ...
    <div>
      ...
      <main>
        <section className="first-section" id="features">
          ...
          <div className="third-section-block">
            <div className="third-section-logo" data-aos="fade-left">
              ...
              <p>
                <span>2-factor authentication and user-controlled encryption are</span>
                <span>
        ...
        <section className="second-section">
          ...
          <div data-aos="fade-up-left"  className="productive">
            <h1>
              <span>Stay productive,</span>
              <span className="span" > wherever you are</span>
            </h1>
            <p>
